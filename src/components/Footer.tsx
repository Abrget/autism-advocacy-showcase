    ...
    <footer className="bg-gray-900 text-white pt-16 pb-6">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div>
            <h3 className="text-xl font-semibold mb-4">Autism Foundation</h3>
            <p className="text-gray-400 mb-4">
              Supporting individuals and families affected by autism through awareness, education, and community.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Educational Materials</a></li>
          ...
          <div>
            ...
            <form className="space-y-2">
              <input
                ...
                className="w-full px-4 py-2 rounded-md bg-gray-800 border border-gray-700 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-autism-blue"
              />
              <button
                type="submit"
                className="w-full px-4 py-2 bg-autism-blue text-white rounded-md hover:bg-opacity-90 transition-colors"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 text-center text-gray-400 text-sm">
          <p>&copy; {new Date().getFullYear()} Autism Foundation. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
