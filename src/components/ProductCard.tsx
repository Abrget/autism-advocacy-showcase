...
const ProductCard = ({ id, title, price, image, category, description }: ProductCardProps) => {
  ...
  return (
    <>
      <div 
        className="relative bg-white rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl cursor-pointer"
      ...
      >
        ...
        <div className="p-5">
          ...
          <div className="flex justify-between items-center">
            ...
            <button 
              className="px-4 py-2 rounded-full bg-autism-softBlue text-autism-blue text-sm font-medium hover:bg-autism-blue hover:text-white transition-colors"
              onClick={(e) => {
                e.stopPropagation();
                setShowPopup(true);
              }}
      ...
      {showPopup && (
        <ProductPopup 
          ...
          product={{
            ...
            price,
            image,
            category: category === "tshirt" ? "T-Shirt" : "Book"
          }}
        />
      )}
    </>
