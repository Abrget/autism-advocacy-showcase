...
const Hero = () => {
  ...
  return (
    <section 
      ...
      style={{ 
        backgroundImage: "url('https://images.unsplash.com/photo-1516627145497-ae6968895b40')",
    ...
    >
      ...
      <div className="container mx-auto px-6 py-16 pt-32 md:pt-16 flex flex-col md:flex-row items-center z-10">
        ...
        <div className="md:w-1/2 flex justify-center items-center" data-animate>
          {/* Removed the image container since we're using a background image now */}
        </div>
      </div>
